# VR False-Bottom Guard Phase 6 Report
...
### Episode summary
| event | baseline_final | phase2_final | phase3_final | phase6_final | phase2_delta | phase3_delta | phase6_delta | baseline_dd | phase2_dd | phase3_dd | phase6_dd | baseline_min_pool | phase2_min_pool | phase3_min_pool | phase6_min_pool | phase2_pool_relief | phase3_pool_relief | phase6_pool_relief | baseline_near_zero_days | phase2_near_zero_days | phase3_near_zero_days | phase6_near_zero_days |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
### Trade behavior
| event | baseline_exec | phase2_exec | phase3_exec | phase6_exec | phase2_partial | phase3_partial | phase6_partial | phase2_delayed | phase3_delayed | phase6_delayed | phase2_blocked | phase3_blocked | phase6_blocked | phase2_avg_delay_bars | phase3_avg_delay_bars | phase6_avg_delay_bars |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| event | phase2_guard_active_days | phase3_guard_active_days | phase6_guard_active_days | phase2_resets | phase3_resets | phase6_resets | phase2_avg_days_to_first_buy_after_reset | phase3_avg_days_to_first_buy_after_reset | phase6_avg_days_to_first_buy_after_reset | phase2_reset_missed_rebound_cases | phase3_reset_missed_rebound_cases | phase6_reset_missed_rebound_cases | phase2_reset_false_positive_rate_pct | phase3_reset_false_positive_rate_pct | phase6_reset_false_positive_rate_pct |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 2011 Debt Ceiling | 170 | 124 | 124 | 21 | 15 | 15 | 32.33 | 33.4 | 33.4 | 5 | 4 | 4 | 71.43 | 80 | 80 |
| 2018 Q4 | 137 | 127 | 127 | 9 | 8 | 8 | - | - | - | 1 | 1 | 1 | 44.44 | 50 | 50 |
| 2020 Covid Crash | 139 | 111 | 111 | 20 | 15 | 15 | 27.2 | 27.2 | 27.2 | 7 | 5 | 5 | 50 | 60 | 60 |
| 2022 Fed Bear | 341 | 318 | 318 | 31 | 26 | 26 | 117.92 | 104 | 104 | 9 | 6 | 6 | 58.06 | 61.54 | 61.54 |
| 2024 Yen Carry | 87 | 81 | 81 | 6 | 4 | 4 | - | - | - | 2 | 2 | 2 | 66.67 | 50 | 50 |
| 2025 Tariff Shock | 131 | 119 | 119 | 11 | 9 | 9 | 157.63 | 158.67 | 158.67 | 3 | 3 | 3 | 63.64 | 55.56 | 55.56 |

### Override diagnostics
| event | phase6_snapback_candidate_flag_days | phase6_low_reentry_flag_days | phase6_first_buy_override_used_count | phase6_override_triggered_count |
| --- | --- | --- | --- | --- |
| 2011 Debt Ceiling | 249 | 271 | 0 | 0 |
| 2018 Q4 | 71 | 84 | 0 | 0 |
| 2020 Covid Crash | 264 | 292 | 1 | 1 |
| 2022 Fed Bear | 155 | 159 | 0 | 0 |
| 2024 Yen Carry | 35 | 45 | 0 | 0 |
| 2025 Tariff Shock | 82 | 94 | 0 | 0 |

### 2025 episode note
| event | baseline_final | phase2_final | phase3_final | phase6_final | phase2_miss_cost_10d_pct | phase3_miss_cost_10d_pct | phase6_miss_cost_10d_pct | phase2_reset_false_positive_rate_pct | phase3_reset_false_positive_rate_pct | phase6_reset_false_positive_rate_pct |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 2025 Tariff Shock | 25773.94 | 25694.26 | 25694.26 | 25694.26 | 4.73 | 4.73 | 4.73 | 63.64 | 55.56 | 55.56 |

## Key findings
- Largest Phase 6 pool relief: 2025 Tariff Shock (4.37 improvement in minimum pool balance)
- Largest Phase 6 miss cost (10d average from blocked/delayed signals): 2020 Covid Crash (24.12%)
